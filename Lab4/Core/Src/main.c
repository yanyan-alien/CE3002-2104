...
int16_t pwmMax = (7200 -200); // Maximum PWM value = 7200 keep the maximum value to 6200
int16_t pwmMin = 8; // offset value to compensate for deadzone
...
int16_t target_angle = 1000; // target angle of rotation,
...
//  	  pwmVal = 1500;          // this will overwrite PID control above
